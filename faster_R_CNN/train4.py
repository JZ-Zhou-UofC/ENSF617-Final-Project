...
class NinjaDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        # ✅ moved tensor conversion here (since no transform now)
...
def train_model(train_loader, val_loader, epochs=15):
    ...
    wandb.init(project="faster-rcnn-traffic", name="no image aug", mode="offline")
...
# =========================
def main():
    dataset = NinjaDataset(IMG_DIR, ANN_DIR, transforms=None)  # no augmentation
